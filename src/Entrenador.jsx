...
function resolverInline(matId, code, texto) {
  ...
  const fn = { jerarquia: resolverJerarquia, lineal: resolverLineal, cuadratica: resolverCuadratica, sistema: resolverSistema, derivada: resolverDerivadaPotencia, densidad: resolverDensidad, cinetica: resolverCinetica, ph: resolverPH, ohm: resolverOhm, regla3: resolverReglaTres }[m.tipo];
...
// ============================================================================
// ENTRENAMÁTICO v36 · Pensamiento Matemático I-VI + CNEyT I-VI (MCCEMS 2025)
// Compañero digital de los 12 cuadernillos extendidos del ecosistema.
// ACTUALIZACIÓN v36 (14 jul 2026) — FASE 18: MODO HARDCORE + AYUDA AL FALLAR
      ...
      <div className="ent-wrap">
        ...
        {vista === "inicio" && (
          <>
            ...
            <div className="card" style={{ borderColor: CI.rojo, background: "#F6E3DE" }}>
