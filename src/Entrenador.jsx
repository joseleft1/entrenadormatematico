...
// ============================================================================
// ENTRENAMÁTICO v18 · Pensamiento Matemático I-VI + CNEyT I-VI (MCCEMS 2025)
// Compañero digital de los 12 cuadernillos extendidos del ecosistema.
// ACTUALIZACIÓN v18 (12 jul 2026) — FASE 4: SEÑALIZACIÓN + COBERTURA PM I-VI.
  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
        ...
        <div style={{ display: "flex", gap: 3 }}>{pasos.map((_, k) => <span key={k} style={{ width: 7, height: 7, borderRadius: "50%", background: k <= idx ? CI.milpa : CI.linea }} />)}</div>
      </div>
      <div style={{ background: CI.papel2, border: `1.5px solid ${CI.ink}`, borderRadius: 10, padding: 16, textAlign: "center" }}>
        <div style={{ fontSize: 22, fontWeight: 800, color: CI.ink, lineHeight: 1.4, whiteSpace: "pre-line" }}>{conResalte(p.linea, p.resalta, p.rojo)}</div>
        {renderVisual(resultado, p)}
        <div style={{ fontSize: 13, color: CI.muted, fontStyle: "italic", marginTop: 10, lineHeight: 1.5 }}>{p.nota}</div>
      </div>
      <div style={{ display: "flex", gap: 8, justifyContent: "center", marginTop: 12 }}>
