...
// ============================================================================
// ENTRENAMÁTICO v21 · Pensamiento Matemático I-VI + CNEyT I-VI (MCCEMS 2025)
// Compañero digital de los 12 cuadernillos extendidos del ecosistema.
// ACTUALIZACIÓN v21 (12 jul 2026) — FASE 7: CORRECCIÓN DEL MODO GUIADO.
  ...
  return (
    <div>
      <svg viewBox={`0 0 ${W} ${H}`} style={{ width: "100%", height: "auto", background: CI.papel2, borderRadius: 10, border: "1.5px solid #2E2A21" }}>
        ...
        <line x1={X(xmin)} y1={Y(0)} x2={X(xmax)} y2={Y(0)} stroke={CI.muted} strokeWidth="1.2" />
        <line x1={X(0)} y1={Y(ymin)} x2={X(0)} y2={Y(ymax)} stroke={CI.muted} strokeWidth="1.2" />
        <line x1={X(x1)} y1={Y(f(x1))} x2={X(x2)} y2={Y(f(x2))} stroke={CI.milpa} strokeWidth="2.6" />
        ...
        {vista === "aprender" && propActivo && (() => {
          ...
          return (
            <>
              ...
              {tipoResolvedorDe(matId, propActivo.code) && (
                <div className="card" style={{ borderColor: CI.azul }}>
                  ...
                  <Resolvedor matId={matId} tipoInicial={tipoResolvedorDe(matId, propActivo.code)} soloTipo ejemploSugerido={ejemploResolvedorEmbebido} />
                  {tieneDesglose(matId, propActivo.code) && (
                    <button className="tab" style={{ width: "100%", marginTop: 12, padding: "9px 0" }} onClick={() => iniciarGuiado(propActivo)}>
