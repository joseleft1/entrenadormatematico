...
// ============================================================================
// ENTRENADOR v8 · Pensamiento Matemático I-VI + CNEyT I-VI (MCCEMS 2025)
// Compañero digital de los 12 cuadernillos extendidos del ecosistema.
// ACTUALIZACIÓN v8 (5 jul 2026): Casos reales completos en las 12 materias
...
// ============================================================================
export default function EntrenadorV1() {
  const [prog, setProg] = useState(null);           // progreso persistente
  const [vista, setVista] = useState("inicio");     // inicio | practica | diagnostico | resumen | mapaDiag | aprender | casos
        ...
        {vista === "inicio" && (
          <>
            ...
            {estadoMat.diagnostico === "pendiente" && (
              <div className="card" style={{ borderColor: "#2E2A21", background: "#FDF6E0" }}>
                ...
                <p className="muted" style={{ margin: "6px 0 10px" }}>
                  ...
                  Así el Entrenador te recomienda por dónde empezar — sin adivinar tu nivel por el semestre.
                </p>
                <div className="row">
            ...
            <p className="muted" style={{ marginTop: 14, textAlign: "center" }}>
              📓 Este Entrenador acompaña tu <b>{MAT.cuadernillo}</b>: si un tema se te resiste,
