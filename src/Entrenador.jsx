...
// ============================================================================
// ENTRENAMÁTICO v61 · Pensamiento Matemático I-VI + CNEyT I-VI (MCCEMS 2025)
// Compañero digital de los 12 cuadernillos extendidos del ecosistema.
// ACTUALIZACIÓN v61 (14 jul 2026) — FASE 42: MODO HARDCORE DE 5 CORAZONES.
        ...
        {vista === "inicio" && (
          <>
            ...
            <div className="tabs" role="tablist" aria-label="Semestre">
              {Object.keys(MATERIAS).filter((mid) => MATERIAS[mid].nivel === nivelActivo && MATERIAS[mid].area === areaActiva).map((mid) => (
