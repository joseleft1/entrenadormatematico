...
// ============================================================================
// ENTRENAMÁTICO v31 · Pensamiento Matemático I-VI + CNEyT I-VI (MCCEMS 2025)
// Compañero digital de los 12 cuadernillos extendidos del ecosistema.
// ACTUALIZACIÓN v31 (14 jul 2026) — FASE 16: LECTURA EN VOZ ALTA (opt-in)
      ...
      <div onClick={(e) => e.stopPropagation()} className="card" style={{ maxWidth: 420, width: "100%", marginBottom: 0 }}>
        ...
        {TTS_DISPONIBLE && (
          <>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <button className={`tab ${!leerActivo ? "on" : ""}`} onClick={() => cambiarLeer(false)}>Desactivada</button>
              <button className={`tab ${leerActivo ? "on" : ""}`} onClick={() => cambiarLeer(true)}>🔊 Activada</button>
            </div>
            <p className="muted" style={{ fontSize: 11.5, marginTop: 6, lineHeight: 1.5 }}>Al activarla aparece un botón grande «🔊 Escuchar esta pantalla» en Aprender, y un 🔊 junto a cada bloque (¿Por qué funciona?, Más sobre este tema, casos y pasos) para elegir qué leer. Usa la voz del propio equipo — funciona sin internet.</p>
          </>
        )}
