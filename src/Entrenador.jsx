...
// ============================================================================
// ENTRENAMÁTICO v27 · Pensamiento Matemático I-VI + CNEyT I-VI (MCCEMS 2025)
// Compañero digital de los 12 cuadernillos extendidos del ecosistema.
// ACTUALIZACIÓN v27 (14 jul 2026) — FASE 13: CONTENIDO DE LOS CUADERNILLOS
...
function PanelContexto({ matId, propActivo }) {
  const [abierto, setAbierto] = useState(false);
        ...
        {vista === "aprender" && propActivo && (() => {
          ...
          return (
            <>
              ...
              <PanelContexto matId={matId} propActivo={propActivo} />
