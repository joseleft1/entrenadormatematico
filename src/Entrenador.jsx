...
function LienzoFisica({ setup, alto = 200, deps = [], onApi, onTap, fondo }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // tocar para soltar/spawn (coordenadas relativas al canvas)
      if (typeof onTap === "function") {
        tapHandler = (ev) => {
          const rect = render.canvas.getBoundingClientRect();
          const cx = (ev.touches ? ev.touches[0].clientX : ev.clientX) - rect.left;
          const cy = (ev.touches ? ev.touches[0].clientY : ev.clientY) - rect.top;
          onTap(api, cx * (W / rect.width), cy * (H / rect.height));
        };
...
// ============================================================================
// ENTRENAMÁTICO v22 · Pensamiento Matemático I-VI + CNEyT I-VI (MCCEMS 2025)
// Compañero digital de los 12 cuadernillos extendidos del ecosistema.
// ACTUALIZACIÓN v22 (12 jul 2026) — FASE 8: LIBRERÍAS GRÁFICAS + ESCAPE.
