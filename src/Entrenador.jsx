...
// ============================================================================
// ENTRENAMÁTICO v19 · Pensamiento Matemático I-VI + CNEyT I-VI (MCCEMS 2025)
// Compañero digital de los 12 cuadernillos extendidos del ecosistema.
// ACTUALIZACIÓN v19 (12 jul 2026) — FASE 5: CASCADA + CALCULADORA + GUIADO.
...
function CalculadoraCientifica({ matId }) {
  ...
  return (
    <div>
      ...
      {desglose && (
        <div style={{ background: "#FFFDF6", border: "1.5px solid #2E2A21", borderRadius: 12, padding: 14, marginBottom: 10 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
            <span style={{ fontSize: 11, fontWeight: 800, letterSpacing: 0.5, color: "#355070", textTransform: "uppercase" }}>Resuelto paso a paso</span>
...
function DesglosePasos({ resultado }) {
  ...
  return (
    <div>
      ...
      <FilaPaso resultado={resultado} p={p} idx={idx} total={pasos.length} />
      <div style={{ display: "flex", gap: 8, justifyContent: "center", marginTop: 12 }}>
...
function Resolvedor({ matId }) {
  const [tipo, setTipo] = useState("jerarquia");
  ...
  return (
    <div>
      ...
      <p style={{ margin: "10px 0 6px", fontSize: 12, color: CI.muted }}>{T.ayuda}</p>
      <div style={{ display: "flex", gap: 6, marginBottom: 6 }}>
        <input value={entrada} onChange={(e) => setEntrada(e.target.value)} onKeyDown={(e) => { if (e.key === "Enter") resolver(); }} placeholder={T.ph}
      ...
      {!resultado && (
        <p style={{ fontSize: 12, color: CI.muted, fontStyle: "italic", marginTop: 10, lineHeight: 1.5 }}>
          Ejemplo para probar: <button style={{ background: "none", border: "none", color: CI.azul, cursor: "pointer", padding: 0, fontSize: 12, textDecoration: "underline" }} onClick={() => setEntrada(T.ph)}>{T.ph}</button>
        </p>
      )}
    </div>
  );
...
export default function EntrenamaticoV1() {
  ...
  // variantes). Intenta varias veces; devuelve {q, desg} o null si ninguna sirve.
  const generarDesglosable = (pr, nv, intentos = 10) => {
      ...
      <div className="ent-wrap">
              ...
              return (
                <div key={pr.code} className="prop-btn" style={{ cursor: "default", flexWrap: "wrap" }}>
                  ...
                  <div style={{ display: "flex", gap: 6, width: "100%", marginTop: 4, flexWrap: "wrap" }}>
                    ...
                    {tieneDesglose(matId, pr.code) && (
                      <button className="tab" style={{ flex: 1, minWidth: 90, padding: "7px", fontSize: 12.5 }} onClick={() => iniciarGuiado(pr)}>Guiado 🧩</button>
                    )}
        ...
        {vista === "herramientas" && (
          <>
            ...
            <div className="card">
              {subHerramienta === "calculadora" ? <CalculadoraCientifica matId={matId} /> : subHerramienta === "graficador" ? <GraficadorFunciones matId={matId} /> : <Resolvedor matId={matId} />}
            </div>
            <button className="btn btn-g btn-block" onClick={() => setVista("inicio")}>← Volver a los propósitos</button>
          </>
        )}
        ...
        {vista === "guiado" && propActivo && guiado && (() => {
          ...
          const responderGuiado = (i) => { if (elegida === null) setGuiado((g) => ({ ...g, elegida: i })); };
          return (
            <>
              <div className="card">
                ...
                <div style={{ background: "#E7ECF3", borderLeft: "4px solid #355070", borderRadius: 8, padding: "11px 13px", marginBottom: 12 }}>
                  <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: 1, textTransform: "uppercase", color: "#355070", marginBottom: 4 }}>1 · Ejemplo resuelto — obsérvalo</div>
                  <div style={{ fontSize: 14, color: "#2E2A21", fontWeight: 700 }}>{ejemplo?.q.texto}</div>
                </div>
                ...
                {fase === "ejemplo" ? (
                  ...
                  <div style={{ marginTop: 16, borderTop: "2px dashed #cabf9d", paddingTop: 14 }}>
                    <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: 1, textTransform: "uppercase", color: "#3D6B35", marginBottom: 8 }}>2 · Ahora tú — mismo tipo, otros números</div>
                    {intento ? (
                      <>
                        ...
                        {verDesg && (
                          <div style={{ background: "#FFFDF6", border: "1.5px solid #2E2A21", borderRadius: 12, padding: 14, marginTop: 10 }}>
                            <p style={{ margin: "0 0 8px", fontSize: 11, fontWeight: 800, letterSpacing: 0.5, color: "#355070", textTransform: "uppercase" }}>Cómo se resolvía</p>
                ...
                return (
                  <div style={{ marginTop: 10 }}>
                    {!verDesglose ? (
                      ...
                      <div style={{ background: "#FFFDF6", border: "1.5px solid #2E2A21", borderRadius: 12, padding: 14 }}>
                        <p style={{ margin: "0 0 10px", fontSize: 11, fontWeight: 800, letterSpacing: 0.5, color: "#355070", textTransform: "uppercase" }}>Resuelto paso a paso</p>
